...
namespace rjwstd
{
    ...
    {
        public static bool std_sex;
        public static bool std_floor;
        public static bool std_show_roll_to_catch;

        public static float std_min_severity_to_pitch;
        public static float std_env_pitch_cleanliness_exaggeration;
        public static float std_env_pitch_dirtiness_exaggeration;
        public static float std_outdoor_cleanliness;
        public static float opp_inf_initial_immunity;
        public static float pawn_spawn_with_std_mul;
        public static float nymph_spawn_with_std_mul;

        public override void ExposeData()
        {

            Scribe_Values.Look(ref std_sex, "std_sex", defaultValue: true, forceSave: true);
            Scribe_Values.Look(ref std_floor, "std_floor", defaultValue: true, forceSave: true);
            Scribe_Values.Look(ref std_show_roll_to_catch, "std_show_roll_to_catch", defaultValue: false, forceSave: true);

            Scribe_Values.Look(ref std_min_severity_to_pitch, "std_min_severity_to_pitch", defaultValue: 0.21f, forceSave: true);
            Scribe_Values.Look(ref std_env_pitch_cleanliness_exaggeration, "std_env_pitch_cleanliness_exaggeration", defaultValue: 2.0f, forceSave: true);
            Scribe_Values.Look(ref std_env_pitch_dirtiness_exaggeration, "std_env_pitch_dirtiness_exaggeration", defaultValue: 0.5f, forceSave: true);
            Scribe_Values.Look(ref std_outdoor_cleanliness, "std_outdoor_cleanliness", defaultValue: -1.0f, forceSave: true);
            Scribe_Values.Look(ref opp_inf_initial_immunity, "opp_inf_initial_immunity", defaultValue: 0.55f, forceSave: true);
            Scribe_Values.Look(ref pawn_spawn_with_std_mul, "pawn_spawn_with_std_mul", defaultValue: 1.0f, forceSave: true);
            Scribe_Values.Look(ref nymph_spawn_with_std_mul, "nymph_spawn_with_std_mul", defaultValue: 3.0f, forceSave: true);
