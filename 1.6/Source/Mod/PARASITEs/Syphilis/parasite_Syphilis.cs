...
namespace rjwparasite
{
	...
	/// </summary>
	public static class parasite_Syphilis
	{
		public static parasite_def syphilis = DefDatabase<parasite_def>.GetNamed("Syphilis");
		...
		public static void roll_for_syphilis_damage(Pawn p)
		{
			...
			// Important Note:
			// this function is called from Need_Sex::NeedInterval(), where it involves a needsex_tick and a parasite_tick to actually trigger this roll_for_syphilis_damage.
